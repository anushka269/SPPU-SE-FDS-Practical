...
int main()
{
 ...
 case 2:cout<<"Students like vanilla:\n";
 a.display(head); 
 ...
 case 3:cout<<"Students who like both"<<endl;
 a.intersect(head,head1);
 break;
 
 case 4:cout<<"Students who like either vanilla or Butterscotch"<<endl;
 a.unio(head,head1);
 break; 
 
 case 5:cout<<"Students who like only Vanilla"<<endl;
 a.diff1(head,head1);
 break;
 
 case 6:cout<<"Students who like only Butterscotch "<<endl;
 a.diff1(head1,head);
 break; 
 }
